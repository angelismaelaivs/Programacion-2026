'''
Clase para procesar las opciones del menú bancario.
Versión actualizada: incorpora manejo de errores con fechas
y persistencia de cuentas mediante CSV.
@angelismaelaivs@ciencias.unam.mx
'''

from Cuenta import *
from ValidadorFechas import validarFecha
from GestorCuentas import guardarCuentas
